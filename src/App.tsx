...
function App() {
  ...
  const handleMenuSelection = (section: string) => {
    ...
    setMessage(
      `El módulo de ${section} estará disponible próximamente.`,
    );
  };
  ...
  const handleQuickAction = (action: string) => {
    ...
    if (action === 'Nueva solicitud') {
      setActiveItem('Solicitudes');

      setMessage(
        'El módulo de Solicitudes estará disponible próximamente.',
      );
    }
  };
