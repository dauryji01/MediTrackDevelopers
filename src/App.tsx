...
function App() {
  ...
  return (
    <div className="app-layout">
      <Sidebar activeItem={activeItem} onSelectItem={showComingSoon} />
      ...
      <div className="main-area">
        ...
        <main className="dashboard">
          <section className="dashboard-heading">
            ...
            <div className="current-date">Resumen de hoy</div>
          </section>
          ...
          <section className="quick-actions-section">
            <div className="section-title">
              <div>
                ...
                <p>Accede a las operaciones más utilizadas.</p>
              </div>
            </div>
            ...
            <div className="quick-actions">
              ...
              <button
                ...
                onClick={() => handleQuickAction('Agregar medicamento')}
              >
                <PackagePlus size={25} />
              ...
              <button
                ...
                onClick={() => handleQuickAction('Nueva solicitud')}
              >
                <ClipboardPlus size={25} />
          ...
          <section className="dashboard-bottom">
            <article className="panel alerts-panel">
              <div className="panel-header">
                <div>
                  <h3>Alertas</h3>
                  <p>Situaciones que necesitan atención.</p>
                </div>
            ...
            <article className="panel sales-panel">
              <div className="panel-header">
                <div>
                  ...
                  <p>Operaciones registradas recientemente.</p>
                </div>
                ...
                <table>
                  ...
                  <tbody>
                    {recentSales.map((sale) => (
                      <tr key={sale.id}>
                        <td className="sale-code">{sale.id}</td>
                        <td>{sale.customer}</td>
                        <td>{sale.items}</td>
